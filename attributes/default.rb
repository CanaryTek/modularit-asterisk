...
default['asterisk']['server']['asterisk_version'] = "13.0.2"
...
default['asterisk']['server']['dahdi_version'] = "2.10.0"
...
when 'rhel','fedora'
  default['asterisk']['build_deps'] = "gcc gcc-c++ make ncurses-devel newt-devel libxml2-devel openssl-devel sqlite-devel libuuid-devel libsrtp-devel jansson-devel"
else
  default['asterisk']['build_deps'] = 'PLEASE_DEFINE'
end
